...
namespace Patterns.RandomCode
{
    ...
    public class TimerCode
    {
        ...
        {
            var alertDataSourcesIdsToPersistMapping =
                    (ConfigurationManager.AppSettings["AlertDataSourcesIdsToPersistMapping"].Split(new char[] { ';' }));
            ...
            // second.
            using (Timer timer = new Timer(handler, state, 2000, 5000))
            {
