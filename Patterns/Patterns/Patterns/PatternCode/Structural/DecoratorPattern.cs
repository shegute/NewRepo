...
namespace DoFactory.GangOfFour.Decorator.Structural
{
    ...
    /// <summary>MainApp startup class for Structural Decorator Design Pattern.</summary>

    class DecoratorMainApp
    {
    ...
    /// <summary>The 'ConcreteDecoratorA' class</summary>
    ...
    /// <summary>The 'ConcreteDecoratorB' class</summary>
